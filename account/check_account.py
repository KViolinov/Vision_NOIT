...
def require_login(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        try:
            ...
            generate_audio_from_text("Нямате достъп до тази функция понеже нямате акаунт или не сте се логнали"
                                     "За да използвате тази фунция, моля логнете се", get_jarvis_voice())
        ...
        if not email or not password:
            from jarvis_functions.essential_functions.change_config_settings import get_jarvis_voice  # 👈 moved here
